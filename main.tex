...
\title{RayCastED: Lightweight and Boundary-Aware Nuclei Detection Model for Histopathology Images%
...
\input{tab/benchmark-efficiency}
...
\input{tab/ablation-rays}

\input{tab/ablation-wavelet}
